...
const PATHS = {
  ...
  image: ["rect:3 5 18 14 2", "circle:8.5 10 1.6", "path:M3.5 17.5l5-5 4.5 4.5 3-2.5 4.5 4"],
};
...
const CAT_ICONS = {
  ...
  // === Дентальный набор ===
  // стоматологическое оборудование — зуб
  "dental-unit": {
    base: ["path:M12 4.2c-2.2-1.6-5.5-.8-5.5 2.4 0 2 .6 3.4 1.1 5.6.3 1.4.4 3.4 1.2 4.6.3.5.9.5 1.2 0 .5-.8.6-2.1.8-3.1.1-.6.6-.6.7 0 .2 1 .3 2.3.8 3.1.3.5.9.5 1.2 0 .8-1.2.9-3.2 1.2-4.6.5-2.2 1.1-3.6 1.1-5.6 0-3.2-3.3-4-5.5-2.4z"],
    accent: ["path:M8.9 7.6c.9-.7 2.1-.9 3.1-.5"],
  },
  // Cad/Cam технологии — 3D-куб (цифровое моделирование)
  cadcam: {
    base: ["path:M12 4l7 4v8l-7 4-7-4V8z", "path:M5 8l7 4 7-4", "path:M12 12v8"],
    accent: ["path:M8.5 6.3l7 4"],
  },
  // зуботехническое оборудование — микроскоп
  lab: {
    base: ["path:M6 20h12", "path:M10 20l-1.5-3.5", "path:M8.5 16.5h4", "path:M10.5 16.5v-2", "path:M10.5 14.5a4 4 0 004-4", "path:M14.5 10.5l1.2-3", "rect:14 6 3.2 2.6 1"],
    accent: ["path:M9 18.5h4"],
  },
  // реанимация и анестезиология — монитор с пульсом
  anesthesia: {
    base: ["rect:3 5 18 11 2", "path:M9 20h6", "path:M12 16v4"],
    accent: ["path:M6 11h2.5l1.3-3 2 6 1.4-3H18"],
  },
...
const CAT_COLORS = {
  // Дентальный набор
  "dental-unit": ["#0ea5a5", "#0b7d7d"], // стомат. оборудование — бирюза
  cadcam:        ["#6d5ce0", "#4a3caa"], // Cad/Cam — индиго
  lab:           ["#2fa46b", "#1f7a4d"], // зуботех. оборудование — зелёный
  anesthesia:    ["#e0576e", "#b23a54"], // реанимация — красный
  furniture:     ["#e0862f", "#b3651c"], // мебель — янтарь

  // Прежние (на случай отката)
  consumables:  ["#0ea5a5", "#0b7d7d"],
  ppe:          ["#3b74d6", "#274f9c"],
  diagnostics:  ["#6d5ce0", "#4a3caa"],
  rehab:        ["#e0862f", "#b3651c"],
  care:         ["#e05a8a", "#b23a68"],
  disinfection: ["#14b8c4", "#0e8a93"],
  clinic:       ["#5b7b95", "#3f5a70"],
};
